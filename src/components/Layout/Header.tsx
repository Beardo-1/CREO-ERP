...
export function Header({ activeTab, userName, onMobileMenuToggle }: HeaderProps) {
    ...
    <header className="header-gradient border-b border-white/20 px-4 lg:px-6 py-3 relative shadow-lg">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <button className="hidden sm:flex w-10 h-10 items-center justify-center text-gray-600 hover:text-gray-900 hover:bg-white/50 rounded-xl transition-all duration-200 hover:scale-105 backdrop-blur-sm">
            <Settings className="w-5 h-5" />
          </button>
          
          {/* 4. Account - Responsive */}
          <div className="flex items-center space-x-2 bg-white/50 backdrop-blur-sm rounded-xl px-2 py-1.5 hover:bg-white/70 transition-all duration-300 cursor-pointer group border border-white/20 h-8 sm:h-10">
